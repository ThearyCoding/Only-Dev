...
class Singleton {
  ...
  /// Assign a concrete delegate for text localization.
  static AssetPickerTextDelegate textDelegate = const EnglishAssetPickerTextDelegate();

  /// Assign a common sort path delegate.
